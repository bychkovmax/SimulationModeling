...
%PATH_XJAL% -version:1.6+ -cp com.xj.anylogic.engine.jar;com.xj.anylogic.engine.nl.jar;com.xj.anylogic.engine.al3d.jar;model.jar;com.xj.anylogic.engine.sa.jar -Xmx256m materialPrediction.Simulation %*
